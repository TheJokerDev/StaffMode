...
import me.thejokerdev.staffmode.enums.ItemRequirements;
...
public class Button {
    ...
    public List<String> leftClickActions(){
        return new ArrayList<>(section.getStringList("actions.leftclick"));
    }
    public List<String> rightClickActions(){
        return new ArrayList<>(section.getStringList("actions.rightclick"));
    }
    public List<String> shiftClickActions(){
        return new ArrayList<>(section.getStringList("actions.shiftclick"));
    }
    public List<String> allClickActions(){
        return new ArrayList<>(section.getStringList("actions.multiclick"));
    }
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                if (update){
                    ...
                    for (Button b : Main.getPlugin().getDataManager().getDataPlayer(getPlayer()).getItems().values()){
