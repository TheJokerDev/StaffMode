...
import me.thejokerdev.staffmode.commands.StaffChatCMD;
...
import me.thejokerdev.staffmode.commands.StaffModeCMD;
...
public class CMDManager {
    ...
    public CMDManager(Main plugin){
        ...
        commands.add(new StaffModeCMD(plugin));
        commands.add(new StaffChatCMD(plugin));
